		   ...
		   <?php
			...
			<h5 align="center" style="color:black" ><b>Datewise Expense Report From <?php echo $fdate?> To <?php echo $tdate?></b></h5>
			 ...
			 <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
			  ...
			  <?php
				$id=$_SESSION['u_id'];
				$ret=mysqli_query($db,"SELECT ExpenseDate,SUM(ExpenseCost) as totaldaily FROM `Expense_tbl`  where (ExpenseDate BETWEEN '$fdate' and '$tdate') && (UserId='$id') group by ExpenseDate");
				$cnt=1;
			  ...
			  <tr>
				...
				<td><b><?php  echo $ttlsl=$row['totaldaily'];?></b></td>
			  </tr>
			  <?php
				$totalsexp+=$ttlsl; 
				$cnt=$cnt+1;
			  ...
			  ?>
			  <tr>
				<th colspan="2" style="text-align:center">Grand Total</th>   <td style="color;background-color: orange"><b><?php echo $totalsexp;?></b></td>
			  </tr>     
			</table>
		   </div>
		  </div>
