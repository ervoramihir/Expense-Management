...
<head>
	...
	<title>Today's Expense - Expense Management</title>
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<ol class="breadcrumb">
			<li><a href="dashboard.php">
				...
				<li class="active"><b>Today's Expense </b></li>
		</ol>
	</div><!--/.row-->
...
<div class="row" style="margin-top: 20px;">
	<div class="col-lg-12">
		<div class="panel panel-default">
			<div class="panel-heading" style="color:blue"><b>Today's Expense </b>	</div>
...
$todaydate=date('Y-m-d');
		 $id=$_SESSION['u_id'];
		 $ret=mysqli_query($db,"SELECT ExpenseDate,ExpenseItem,ExpenseCost FROM `Expense_tbl` where (ExpenseDate='$todaydate' and '$todaydate') && (UserId='$id')  ");
			$cnt=1;
