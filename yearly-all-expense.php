...
<head>
	...
	<title>Current Year Expenses - Expense Management</title>
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<ol class="breadcrumb">
			<li><a href="dashboard.php">
				...
				<li class="active"><b>Current Year Expenses</b></li>
		</ol>
	</div><!--/.row-->
...
<div class="row" style="margin-top: 20px;">
	<div class="col-lg-12">
		<div class="panel panel-default">
			<div class="panel-heading" style="color:blue"><b>Current Year Expenses</b>	</div>
...
<?php
 $cyear = date('Y');
		 $id=$_SESSION['u_id'];
			$crrntdte=date("Y-m-d");
		 $ret=mysqli_query($db,"SELECT ExpenseDate,ExpenseItem,ExpenseCost FROM `Expense_tbl` where (Year(ExpenseDate) = '$cyear') AND UserId='$id' ; ");
